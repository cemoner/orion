...
const SustainabilitySection = () => {
  ...
  return (
   <section className="relative w-full shadow:2xl text-white overflow-hidden" style={{ maxHeight: '500px' }}>
      <div className="w-full relative" style={{ aspectRatio: '3.066', minHeight:'300px' }}>
        <Image
