    ...
    <header className="bg-background dark:bg-background-dark shadow-md rounded-b-lg w-full md:sticky top-0 z-50 h-20 flex items-center justify-between relative">
      <div className="mx-auto w-full px-6 py-6 flex justify-between items-center">
        ...
        <div className="flex items-center gap-x-5">
          ...
          <div className="md:hidden">
            ...
            >
              {isMenuOpen ? (
                <svg className="h-7 w-6 text-background-dark dark:text-background" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      >
        <nav className="flex flex-col items-center space-y-4 py-4">
          <Link href="/" className="text-text dark:text-text-dark text-md hover:text-hover-blue w-full text-center shadow-sm py-2">
            {t("nav.home")}
          </Link>
          <Link href="/products" className="text-text dark:text-text-dark text-md hover:text-hover-blue w-full text-center shadow-sm pb-4">
            {t("nav.products")}
          </Link>
          <Link href="/about" className="text-text dark:text-text-dark text-md hover:text-hover-blue w-full text-center shadow-sm pb-4">
            {t("nav.about")}
          </Link>
          <Link href="/contact" className="text-text dark:text-text-dark text-md hover:text-hover-blue w-full text-center shadow-sm pb-4">
            {t("nav.contact")}
          </Link>
          <Link href="/offer" className="text-text dark:text-text-dark text-md hover:text-hover-blue w-full text-center shadow-sm pb-4">
            {t("nav.offer")}
          </Link>
          <Link href="/references" className="text-text dark:text-text-dark text-md hover:text-hover-blue w-full text-center py-0">
            {t("nav.references")}
          </Link>
        </nav>
      </div>
