...
const projectReferences = [
  { name: "Tekel Baş Md. Binası", year: "1999", product: "İzosil", location: "Bursa" },
  { name: "Adliye Lojmanları – Çekirge PTT bitişiği", year: "2000", product: "Flex-Coat", location: "Bursa" },
  { name: "Nilüfer Hatun Cad. Kuğu Sitesi-51 Ataevler", year: "2000", product: "Izosi!", location: "Bursa" },
  { name: "Gökşin Sitesi", year: "1999", product: "Flex-Coat", location: "Beşevler- Bursa" },
  { name: "DSİ Lojmanları – Akroteks", year: "2004", product: "Sctbaşı", location: "Bursa" },
  { name: "Askeriye Lojmanları", year: "2000", product: "İzonit, Yağlı Boya", location: "Hüriyet -Bursa" },
  { name: "Sedir Sitesi", year: "2004", product: "İzosil-Enamel-Trf. Yol Çizgi Boyası", location: "Ataevler – Bursa" },
  { name: "İbrahim Uyar İlköğretim Okulu", year: "2004", product: "İzosil", location: "Ataevler – Bursa" },
  { name: "Yunus Emre Spor Kopleksi", year: "2003", product: "Akroteks,Saten,Plastik", location: "Bursa" },
  { name: "Yıldırım Belediyesi Trafik Yol Çizgi Boyası", year: null, product: "Trafik Yol Çizgi Boyası", location: "Bursa" },
  { name: "Confetti Tekstil Fabrikası", year: "2003", product: "İzosil", location: "Organize Sanayi-Bursa" },
  { name: "Elvinteks Tekstil Fabrikası", year: "2003", product: "Akroteks", location: "Çalı Yolu – Bursa" },
  { name: "Kapsan Kaplama Sanayi", year: "2003", product: "Akroteks", location: "Organize Sanayi -Bursa" },
  { name: "Otosansit Sitesi -Büyük Oto Parçacılar Sitesi", year: "2003-2004", product: "Akroteks,Plastik", location: "Bursa" },
  { name: "Işıklar Askeri Lisesi", year: "2003", product: "İzokot", location: "Bursa" },
  { name: "Milli Piyango Anadolu Lisesi", year: "2005", product: "Akroteks- Plastik", location: "Bursa" },
  { name: "Emniyet Müdürlüğü Binası", year: "1999", product: "Flex-Coat", location: "Mudanya – Bursa" },
  { name: "Çağlayaner Yapı Koop. 600 daire (Aslantaş)", year: "1999-2000", product: "Serkot", location: "Mudanya" },
  { name: "Şalıbender Baysan Siteleri", year: "2000", product: "Flex-Coat", location: "Güzelyalı" },
  { name: "Baytaş Siteleri", year: "1999", product: "Flex-Coat", location: "Gemlik girişi" },
  { name: "Kemal Pireci Lisesi", year: "1999", product: "İzosil", location: "Bandırma" },
  { name: "Kırcı Un Fabrikası", year: "1999", product: "İzosil", location: "Bandırma" },
  { name: "Debleke Un Fabrikası", year: "2000", product: "Flex-Cöat", location: "Bandırma" },
  { name: "Beyköy Un Fabrikası", year: "1999", product: "Flex-Coat", location: "Bandırma" },
  { name: "6.Ana Jet Üs Kom.", year: "1998-2003", product: "Flex-Coat,Akroteks,Plastik,Yağlı Boya,İzoteks", location: "Bandırma" },
  { name: "Etibaıık Tesisleri", year: "1999", product: "Flex-Coat", location: "Bandırma" },
  { name: "Sümer Yapı Koop.", year: "1999", product: "Flcx-Coat", location: "Bandırma" },
  { name: "Serpin Manyas Kaplıcaları", year: "2005", product: "İzosil", location: "Manyas-Baııdırma" },
  { name: "9. Ana Jet Üssü Lojmanları", year: "2000", product: "Flex-Coat", location: "Balıkesir" },
  { name: "Tedaş Lojmanları", year: "1999-2000", product: "İzosil, Flex-Coat", location: "Balıkesir" },
  { name: "Mühimmat Depo Kom. Lojmanları", year: "2000", product: "Flex-Coat,Akroteks", location: "Susurluk" },
  { name: "Akbaıık Dinlenme Tesisleri", year: "2000", product: "Akroteks,Plastik", location: "Erdek" },
  { name: "Donanma Komutanlığı", year: "1998-2000", product: "Flex-Coat", location: "Gölcük" },
  { name: "Donanma Komutanlığı Yahya Kaptan Loj.", year: "1999-2000", product: "Flex-Coat", location: "İzmit" },
  { name: "Bil-Koop Sitesi", year: "2000", product: "Akroteks", location: "Bilecik" },
  { name: "Jandarma Er Eğitim Tugayı", year: "2000", product: "Akroteks", location: "Bilecik" },
  { name: "Eronur Hotel", year: "2000", product: "Flex-Coat", location: "Bilecik" },
  { name: "Onurlar Apartmanı", year: "2000", product: "Flex-Coat", location: "Bilecik" },
  { name: "Önçay İnşaat", year: "2000", product: "Akroteks", location: "Eskişehir" },
  { name: "Haser İnşaat", year: "2000", product: "İzonit", location: "Eskişehir" },
  { name: "Osmangazi Üniversitesi Ek Binası", year: "1998–1999", product: "Betonkot", location: "Eskişehir" },
  { name: "Şirinkent Gül Ağaçları Sitesi", year: "2000", product: "Flex-Coat", location: "Kütahya" },
  { name: "Poyraz Konut Yapı Koop.", year: "1999", product: "Akroteks", location: "Kütahya" },
];
...
const ReferencesPage = () => {
  ...
  const currentProjects = projectReferences.slice(indexOfFirstProject, indexOfLastProject);
  const totalProjectPages = Math.ceil(projectReferences.length / projectsPerPage);
  ...
  const currentPartners = businessPartners.slice(indexOfFirstPartner, indexOfLastPartner);
  const totalPartnerPages = Math.ceil(businessPartners.length / partnersPerPage);
        ...
        <section>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6 md:gap-8 min-h-[480px]">
            {currentPartners.map((partner, index) => (
              ...
              >
                <Building2 className="w-10 h-10 text-logo-blue dark:text-hover-blue mb-3" strokeWidth={1.5} />
          ...
          <div className="mt-12 flex justify-center items-center space-x-2">
            ...
            {Array.from({ length: totalPartnerPages }, (_, i) => i + 1).map((page) => (
              <button
                key={page}
                ...
                <div className="p-6 flex-grow">
                  ...
                  <div className="space-y-3 text-text/90 dark:text-text-dark/80">
                    ...
                    <div className="flex items-start">
                      ...
                      <span className="text-sm font-medium">{project.product || '-'}</span>
                    </div>
                  </div>
                </div>
